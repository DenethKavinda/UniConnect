...
function NavItem({ item, isOpen, onToggle }) {
  ...
  const base = {
    ...
    background: isActive || isChildActive
      ...
      : "transparent",
    color: isActive || isChildActive ? "#5eead4" : isDark ? "#7b8ba3" : "#475569",
  ...
  return (
    <div
      style={{
        ...
        borderRight: isDark ? "1px solid rgba(148,163,184,0.14)" : "1px solid #cbd5e1",
        display: "flex",
        flexDirection: "column",
    ...
    >
      ...
      <div
        style={{
          borderTop: isDark ? "1px solid rgba(148,163,184,0.16)" : "1px solid #dbeafe",
          margin: "14px 4px",
        }}
      />
