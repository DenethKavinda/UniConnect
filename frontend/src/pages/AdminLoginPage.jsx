      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-6 py-12">
        <div className="w-full max-w-md relative overflow-hidden bg-[rgba(255,255,255,0.03)] rounded-[2.5rem] p-8 md:p-10 border border-white/10 shadow-2xl">
          ...
          <div className="relative z-10">
            <h2 className="mb-2 text-center text-3xl font-bold text-white">Admin Login</h2>
            <p className="mb-6 text-center text-sm text-slate-400">Sign in as an administrator</p>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    value={form.password}
                    onChange={handleChange}
                    className="w-full rounded-xl border border-slate-700 bg-[#050b19] px-4 py-3 pr-12 text-white placeholder-slate-500 outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/30"
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-2 rounded-lg text-slate-400 hover:text-white hover:bg-white/5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500/50"
            ...
            <p className="mt-5 text-center text-sm text-slate-400">
              Not an admin? <Link to="/login" className="font-semibold text-teal-400 hover:text-teal-300">Student Login</Link>
            </p>
          </div>
        </div>
      </div>
