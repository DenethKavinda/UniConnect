          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between">
              <p className="text-sm text-slate-400">
                {posts.length} posts · {SUBJECTS.length - 1} subjects
              </p>
              <Link
                to="/posts/create"
                className="app-btn-primary font-semibold px-4 py-2 rounded-lg hover:brightness-110 transition-all"
              >
                + Create Post
              </Link>
            </div>
            ...
            {loading ? (
              <div className="space-y-4">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div
                    key={i}
                    className="rounded-2xl border border-white/10 bg-white/[0.06] h-32 animate-pulse"
                  />
                ))}
              </div>
            ...
            <div className="space-y-4 sticky top-[90px]">
              ...
              <div className="bg-white/[0.06] border border-white/10 backdrop-blur-xl rounded-2xl p-4">
                <h3 className="text-sm font-semibold text-slate-200 mb-2">
                  About UniConnect Forum
                </h3>
                <p className="text-xs text-slate-400 leading-relaxed">
                  A Reddit-style platform for students to share knowledge, ask
                  questions, and support each other across all courses.
                </p>
                <Link
                  to="/posts/create"
