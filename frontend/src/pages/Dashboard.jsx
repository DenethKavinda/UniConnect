...
const modules = [
  ...
  },
  {
    ...
    icon: <FiMessageSquare />, // fixed icon
    to: "/forum",
      ...
      <header className="relative overflow-hidden bg-slate-900 rounded-3xl p-10 mb-10 border border-white/10 shadow-2xl">
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-400 text-lg max-w-2xl leading-relaxed">
            ...
            and 5 new messages in your study groups.
          </p>
        </div>
      </header>

      <div className="grid grid-cols-1 lg:grid-cols-8 gap-8 mt-8">
        {/* LEFT SIDE: Main Content (4 Columns) */}
            ...
            <header className="relative overflow-hidden bg-[rgba(255,255,255,0.03)] rounded-[2.5rem] p-10 md:p-14 border border-white/10 shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <h1 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight">
                  Welcome back, <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-amber-400">
                    {user?.name || 'Scholar'}
                  </span> 👋
                </h1>
                <p className="text-slate-300 text-lg max-w-xl leading-relaxed">
                  Ready to continue? You have <span className="text-white font-bold underline decoration-amber-500 decoration-2 underline-offset-4">3 tasks</span> pending today.
                </p>
              </div>
            </header>
...
<<<<<<< HEAD
    <div className="text-xl bg-white/5 p-3 rounded-xl group-hover:scale-110 transition-transform">
      {icon}
    </div>
    <div>
...
<<<<<<< HEAD
    <div
      className={`w-10 h-10 rounded-full ${color === "blue" ? "bg-blue-500/20 text-blue-400" : "bg-amber-500/20 text-amber-400"} flex items-center justify-center text-xs font-bold flex-shrink-0 group-hover:scale-110 transition-transform`}
    >
=======
...
<<<<<<< HEAD
        ...
        <span
          className={`${color === "blue" ? "text-blue-400" : "text-amber-400"} font-medium`}
        >
          {target}
        </span>
      </p>
