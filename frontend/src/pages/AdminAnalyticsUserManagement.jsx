...
function AdminAnalyticsUserManagement() {
  ...
  const colors = {
    ...
    cardBorder: isDark ? "#1e293b" : "#cbd5e1",
    cardBg: isDark
    ...
    pageBase: isDark ? "#050b19" : "#f1f5f9",
    textBase: isDark ? "#f1f5f9" : "#0f172a",
  };
          ...
          >
            <div
              style={{
                ...
                boxShadow: isDark ? "0 4px 24px rgba(0,0,0,0.3)" : "0 4px 24px rgba(15,23,42,0.08)",
              }}
            >
